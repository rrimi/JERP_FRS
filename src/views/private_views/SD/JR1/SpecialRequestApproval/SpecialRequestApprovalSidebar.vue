<template>
    <div id="special-request-sidebar" class="special-request-sidebar">
        <div class="layout-sidebar special_request">
...
.special-request-sidebar {
    height: calc(100vh - (74px + 54px + 32px));
}
.layout-sidebar.special_request .header .row1 {
    height: 38px;
}
.layout-sidebar.special_request .header .row1 .form-group {
     overflow: hidden;
     height: 38px; 
}
.layout-sidebar.special_request .header .row1 .form-group svg {
    position: absolute;
    top: 12px;
    left: 10px;
    color: #AAC0D9;
...
.layout-sidebar.special_request .header .row2 .customer-info span{
    font-weight: 500;
    padding-top: 4px;
    padding-right: 8px;
...
.layout-sidebar.special_request .content .card_body {
    cursor: pointer;
}
.layout-sidebar.special_request .content .card_body .row2 h5 {
    margin: 0;
    font-weight: 500;
    line-height: 1.2;
}
...
.layout-sidebar.special_request{
...
.layout-sidebar.special_request .header .row2{
    background-color: var(--white);
    padding: 15px 10px;
}
.layout-sidebar.special_request .header .row2 p{
    display: inline-flex;
    width: 100%;
}
.layout-sidebar.special_request .header .row2 .form-control{
    font-size: 10px;
...
.layout-sidebar.special_request .header .row1 .form-group input{
    padding-left: 36px;
    border-radius: 2px;
...
.layout-sidebar.special_request .header .row1 .filter_search{
    color: #AAC0D9;
    font-size: var(--font16);
    text-align: center;
    padding: 8px;
...
.layout-sidebar.special_request .header .row1 .filter_search:hover{
    color: var(--white);
...
.layout-sidebar.special_request .content .card_body:hover,
.layout-sidebar.special_request .content .card_body:active {
    background-color: var(--bluish-white);
}
.layout-sidebar.special_request .content .card_body .row1,
.layout-sidebar.special_request .content .card_body .row2,
.layout-sidebar.special_request .content .card_body .row3 {
    margin: 1px 0px;
    display: flex;
    justify-content:space-between; 
}
.layout-sidebar.special_request .content .card_body .row1 .order-status{
	color: #f0ad4e ;
}
.layout-sidebar.special_request .content .card_body .row3 .zmdi-check-square{
	color: var(--blue);
}
.layout-sidebar.special_request .content .card_body .row2 h5 {
    font-size: var(--font14);
...
.layout-sidebar.special_request .content .card_body .row2 .tag {
    text-align: center;
...
.layout-sidebar.special_request .content .card_body .row2 .tag .p .span{
    text-align: center;
    font-size: var(--font10) ;
...
.layout-sidebar.special_request .content .card_body .row1 p {
    font-size: var(--font14) ;
    color: var(--text-black);
}
.layout-sidebar.special_request .content .card_body .row3 p {
    font-size: var(--font14);
    color: #879097;
}
</style>