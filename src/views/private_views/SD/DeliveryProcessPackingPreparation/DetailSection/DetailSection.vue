                  ...
                  <v-tabs-items v-model="tab" class="tab-container" style="padding-top: 30px">
                    <v-tab-item v-for="(status, i) in status_list" :key="i">
                      <v-card color="basil" flat>
                        <v-card v-if="status.status_name === 'Initial Phase'"><DetailDataList :tab="status.status_name" :PROD_PREPARATION_LIST="PROD_PREPARATION_LIST" :PROD_PREPARATION_LIST_HEADER_INFO="PROD_PREPARATION_LIST_HEADER_INFO" /></v-card>
                        <v-card v-if="status.status_name === 'Prepare Delivery'"><DetailDataList :tab="status.status_name" :PROD_PREPARATION_LIST="PROD_PREPARATION_LIST" :PROD_PREPARATION_LIST_HEADER_INFO="PROD_PREPARATION_LIST_HEADER_INFO" /></v-card>
                        ...
                        <v-card v-if="status.status_name === 'Ready'"><DetailDataList :tab="status.status_name" :PROD_PREPARATION_LIST="PROD_PREPARATION_LIST" :PROD_PREPARATION_LIST_HEADER_INFO="PROD_PREPARATION_LIST_HEADER_INFO" /></v-card>
                      </v-card>
                    </v-tab-item>
                  </v-tabs-items>
                </v-card>
...
export default {
  props: ["PROD_PREPARATION_LIST", "PROD_PREPARATION_LIST_HEADER_INFO"],
  components: {
    DetailDataList
  },
  data() {
