...
export const router = new VueRouter({
    ...
    routes: [
        ...
        },
        {
            ...
            name: 'SBU PDF TEST',
            component: () =>
                import ('../views/private_views/unknown/SBU_PdfTest.vue')
        },
        {
            path: '/sbu_pdf_test_2',
            name: 'SBU PDF TEST 2',
            component: () =>
                import ('../views/private_views/unknown/SBU_PdfTest_2.vue')
        },
        {
            path: '/sbu_pdf_test_3',
            name: 'SBU PDF TEST 3',
            component: () =>
                import ('../views/private_views/unknown/SBU_PdfTest_3.vue')
        },
        {
            path: '/adm/sbu',
            name: 'SBU',
        ...
        // DS - TRANSFER PACKING PREPARATION
        {
            ...
            component: () =>
                import ('../views/private_views/SD/DS_TransferPackingPreparation/DeliveryProcessPackingPreparation.vue')
        },
        // --------------------------------------------------------------------------------------
        // DS - INVOICE PRINTING
        {
        ...
        // INVOICE CHALLAN SUMMERY 
        {
            ...
            component: () =>
                import ('../views/private_views/SD/InvoiceChallanSummery/InvoiceChallanSummery.vue')
        },
        // --------------------------------------------------------------------------------------
        // PENDING DS INVOICE LIST
        {
            ...
            component: () =>
                import ('../views/private_views/SD/PendingDS_InvoiceList/PendingDS_InvoiceList.vue')
        },
        // --------------------------------------------------------------------------------------
        // DS DISPATCH ENTRY
        {
        ...
        // CREATE ORDER
        {
            ...
            name: 'Create Order',
            component: () =>
                import ('../views/private_views/SD/Order/CreateOrder/CreateOrder.vue')
        },
        // --------------------------------------------------------------------------------------
        // ORDER APPROVAL
        {
            ...
            name: 'Order Approval',
            component: () =>
                import ('../views/private_views/SD/Order/OrderApproval/OrderApproval.vue')
        },
        // --------------------------------------------------------------------------------------
        // DELIVERIES
        {
            ...
            name: 'Deliveries',
            component: () =>
                import ('../views/private_views/SD/Deliveries/Deliveries.vue')
        },
        // --------------------------------------------------------------------------------------
        // RETURN
        {
            ...
            name: 'Return',
            component: () =>
                import ('../views/private_views/SD/Return/Return.vue')
        },
        // --------------------------------------------------------------------------------------
        // CUSTOMER - CUSTOMER LIST
        {
            ...
            name: 'Customer List',
            component: () =>
                import ('../views/private_views/SD/Customer/CustomerList.vue')
        },
        // --------------------------------------------------------------------------------------
        // CUSTOMER - CREATE CUSTOMER
        {
            ...
            component: () =>
                import ('../views/private_views/SD/Customer/CreateCustomer/CreateCustomer.vue')
        },
        // --------------------------------------------------------------------------------------
        // CUSTOMER - CUSTOMER PROFILE
        {
            ...
            name: 'Create Customer',
            component: () =>
                import ('../views/private_views/SD/Customer/CustomerProfile/CustomerProfile.vue')
        },
        // --------------------------------------------------------------------------------------
        // DOCTOR - DOCTOR LIST
        {
            ...
            name: 'Doctors List',
            component: () =>
                import ('../views/private_views/SD/Doctor/DoctorsList.vue')
        },
        // --------------------------------------------------------------------------------------
        // DOCTOR - DOCTOR CREATE
        {
            ...
            name: 'Create Doctor',
            component: () =>
                import ('../views/private_views/SD/Doctor/CreateDoctor/CreateDoctor.vue')
        },
        // --------------------------------------------------------------------------------------
        // DOCTOR - DOCTOR PROFILE
        {
            ...
            component: () =>
                import ('../views/private_views/SD/Doctor/DoctorProfile/DoctorsProfile.vue')
        },
        // --------------------------------------------------------------------------------------
        // Balance Sheet
        {
            ...
            name: 'Balance Sheet',
            component: () =>
                import ('../views/private_views/SD/BalanceSheet/BalanceSheet.vue')
        },
        // --------------------------------------------------------------------------------------
        // Stock Report
        {
            ...
            name: 'Stock Report',
            component: () =>
                import ('../views/private_views/SD/StockReport/StockReport.vue')
        },
        // --------------------------------------------------------------------------------------
        // DELIVERY GRN
        {
            ...
            name: 'Delivery GRN',
            component: () =>
                import ('../views/private_views/SD/DeliveryGRN/DeliveryGRN.vue')
        },
        // --------------------------------------------------------------------------------------
        // RECEIVE GRN
        {
            ...
            name: 'Receive GRN',
            component: () =>
                import ('../views/private_views/SD/ReceiveGRN/ReceiveGRN.vue')
        },
        // --------------------------------------------------------------------------------------
        // REQUISITION - TRANSFER
        {
            ...
            component: () =>
                import ('../views/private_views/SD/Requisition/TransferRequisition/TransferRequisition.vue')
        },
        // --------------------------------------------------------------------------------------
        // REQUISITION - CREATE
        {
            ...
            component: () =>
                import ('../views/private_views/SD/Requisition/CreateRequisition/CreateRequisition.vue')
        },
        // --------------------------------------------------------------------------------------
        // REQUISITION - Approve
        {
            ...
            component: () =>
                import ('../views/private_views/SD/Requisition/ApproveRequisition/ApproveRequisition.vue')
        },
        // --------------------------------------------------------------------------------------
        // REQUISITION - Verified
        {
            ...
            component: () =>
                import ('../views/private_views/SD/Requisition/TransferVerifyRequisition/TransferVerifyRequisition.vue')
        },
        // --------------------------------------------------------------------------------------
        // REQUISITION - Verified Update
        {
            ...
            component: () =>
                import ('../views/private_views/SD/Requisition/TransferVerifyRequisitionUpdate/TransferVerifyRequisitionUpdate.vue')
        },
        // --------------------------------------------------------------------------------------
        // REQUISITION - Transfer Approve
        {
            ...
            component: () =>
                import ('../views/private_views/SD/Requisition/TransferApproveRequisition/TransferApproveRequisition.vue')
        },
        // --------------------------------------------------------------------------------------
        // REQUISITION - Transfer Approve Update
        {
            ...
            component: () =>
                import ('../views/private_views/SD/Requisition/TransferApproveRequisitionUpdate/TransferApproveRequisitionUpdate.vue')
        },
        // --------------------------------------------------------------------------------------
        // PRODUCTS - ALL PRODUCTS
        {
            ...
            name: 'Products List',
            component: () =>
                import ('../views/private_views/SD/Products/ProductsList/Products.vue')
        },
        // --------------------------------------------------------------------------------------
        // PRODUCTS - PRODUCTS DETAILS
        {
            ...
            component: () =>
                import ('../views/private_views/SD/Products/ProductDetails/ProductDetails.vue')
        },
        // --------------------------------------------------------------------------------------
        // COLLECTION
        {
            ...
            name: 'Collection',
            component: () =>
                import ('../views/private_views/SD/Collection/Collection.vue')
        },
        // --------------------------------------------------------------------------------------
        // CUSTOMER PAYMENT
        {
            ...
            component: () =>
                import ('../views/private_views/SD/Payment/Customer/CustomerPayment.vue')
        },
        // --------------------------------------------------------------------------------------
        // CASH REGISTER
        {
            ...
            name: 'Cash Register',
            component: () =>
                import ('../views/private_views/SD/CashRegister/CashRegister.vue')
        },
        ...
        },
        {
            ...
            name: 'Lock Screen',
            component: () =>
                import ('../views/private_views/LockScreen/LockScreen.vue')
        },
